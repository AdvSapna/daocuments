...
export const SAMPLE = {
  EU:{name:'European Union (MiCA)',status:'legal',summary:'The Markets in Crypto-Assets Regulation (MiCA) entered into full application on December 30, 2024, establishing a harmonised EU-wide framework for crypto-asset issuance, trading, and service provision. ESMA and EBA share supranational oversight. Each EU member state designates a national competent authority (NCA) for day-to-day supervision. MiCA introduces licensing categories for CASPs, rules for asset-referenced tokens (ARTs) and e-money tokens (EMTs), market abuse provisions, and consumer protection requirements.',
    ...
    cases:[],
    framework:{
      title:'EU MiCA — Supranational + National Routing',
      intro:'MiCA establishes EU-wide harmonisation, but supervision operates at two levels: supranational (ESMA and EBA for "significant" CASPs and stablecoins) and national (each Member State\'s National Competent Authority for day-to-day CASP authorisation). Tokenised financial instruments are explicitly excluded from MiCA and routed instead through MiFID II, the Prospectus Regulation, CSDR, and the DLT Pilot Regime.',
      regulators:[
        {name:'ESMA',fullName:'European Securities and Markets Authority',scope:'Supranational',body:'Develops MiCA Regulatory and Implementing Technical Standards (RTS/ITS), coordinates NCAs, and directly supervises CASPs and asset-referenced tokens (ARTs) that meet "significant" thresholds (user count, reserve size, or cross-border activity).'},
        {name:'EBA',fullName:'European Banking Authority',scope:'Supranational',body:'Supervises significant e-money tokens (EMTs) and asset-referenced tokens; sets prudential and reserve standards in coordination with the ECB. Issuers of significant EMTs face direct EBA supervision and enhanced capital/reserve requirements.'},
        {name:'ECB',fullName:'European Central Bank',scope:'Supranational',body:'Consultation role on EMTs interacting with euro-area payment systems and on issuers domiciled in the euro area. ECB opinion is required before NCAs authorise significant stablecoin issuances.'},
        {name:'NCAs',fullName:'National Competent Authorities (27 Member States)',scope:'National',body:'Each Member State designates one NCA for day-to-day CASP authorisation, supervision, and enforcement within its territory. Examples: BaFin (Germany), AMF (France), CSSF (Luxembourg), AFM (Netherlands), CONSOB (Italy), CNMV (Spain), Central Bank of Ireland. CASPs authorised in one Member State can passport across the EU.'},
        {name:'MiFID II / DLT Pilot',fullName:'Parallel regime for financial instruments',scope:'Parallel',body:'Tokenised securities, derivatives, and structured products are explicitly excluded from MiCA — they remain under MiFID II, the Prospectus Regulation, CSDR, and AIFMD/UCITS for funds. The DLT Pilot Regime (Regulation EU 2022/858) provides a sandbox for trading and settling tokenised securities through DLT-based market infrastructures.'},
      ],
    },
    analysis:[
      {activity:'Tokenisation — Funds & Securities',clarity:'clear',body:'MiCA explicitly excludes crypto-assets that qualify as financial instruments under MiFID II — tokenised securities, derivatives, and structured products remain under MiFID II, the Prospectus Regulation, and CSDR. Tokenised UCITS and AIFs continue under their respective fund frameworks. The DLT Pilot Regime (Regulation EU 2022/858) provides a sandbox for trading and settlement of tokenised securities through DLT-based market infrastructures.'},
      {activity:'RWA Tokenisation',clarity:'partial',body:'Treatment depends on the token\'s classification. Tokens that qualify as financial instruments under MiFID II are excluded from MiCA and fall under existing EU financial law. Asset-referenced tokens (ARTs) under MiCA Title III — backed by baskets of real-world assets or fiat — face stringent issuer authorisation, reserve, and disclosure requirements. Custody and off-chain enforcement of the underlying RWA remain governed by the asset\'s home-jurisdiction private law.'},
      {activity:'OTC Desks',clarity:'clear',body:'CASP authorisation under MiCA Article 60 is required for any provider exchanging crypto-assets for funds or for other crypto-assets, including OTC desks. The Travel Rule (Regulation EU 2023/1113) requires originator and beneficiary information on all CASP transfers from December 2024. OTC desks dealing in tokenised financial instruments fall under MiFID II rather than MiCA.'},
      {activity:'Stablecoin-Backed Payments',clarity:'clear',body:'The most comprehensive stablecoin regime to date. E-money tokens (EMTs) under MiCA Title IV must be issued by authorised credit institutions or e-money institutions and 1:1 backed. Asset-referenced tokens (ARTs) under Title III require ESMA/EBA-supervised reserves and redemption rights. Significant tokens (above volume thresholds) trigger enhanced supervision; non-compliant stablecoins face delisting from EU exchanges (Tether\'s USDT precedent).'},
      {activity:'Staking',clarity:'unclear',body:'MiCA does not explicitly regulate staking. Recital 23 acknowledges DeFi and staking sit outside the current scope, with a review clause for future expansion. ESMA has consulted on whether staking-as-a-service falls under CASP "custody and administration of crypto-assets"; pooled staking arrangements may resemble collective investment schemes triggering AIFMD instead.'},
    ]},
  US:{name:'United States',status:'partial',summary:'Dramatic policy shift 2024-2026. GENIUS Act (stablecoins) signed into law; FinCEN/OFAC now proposing AML/sanctions rules for issuers. SEC\'s "Regulation Crypto" sent to White House. CLARITY Act yield compromise nearing resolution in Senate. SEC dismissed 7 major crypto cases in FY2025. Strategic Bitcoin Reserve established by executive order.',
    legislation:[
      ...
      {title:'SEC "Regulation Crypto" — Comprehensive Framework (Proposed)',year:2026,note:'SEC proposal sent to White House OIRA for review; follows Mar 2026 SEC-CFTC MOU on coordinated crypto oversight',url:'https://www.pymnts.com/cryptocurrency/2026/sec-sends-regulation-crypto-proposal-to-white-house/'},
      {title:'GENIUS Act — FinCEN/OFAC AML & Sanctions Rules (Proposed)',year:2026,note:'Requires stablecoin issuers to maintain 1:1 reserves, monthly public disclosures, US-based compliance officers, and ability to block/freeze flagged transactions; enforcement from Jan 2027',url:'https://www.coindesk.com/policy/2026/04/08/u-s-treasury-to-propose-demands-that-stablecoin-firms-be-set-to-police-bad-transactions'},
      {title:'PARITY Act — Digital Asset Tax Reform (Reintroduced)',year:2026,note:'Bipartisan bill by Reps. Horsford (D-Nev.) and Miller (R-Ohio) to modernize crypto taxation',url:'https://www.coindesk.com/policy/2026/04/13/u-s-lawmakers-take-another-swing-at-crypto-tax-policy-with-revised-bill'},
    ],
    news:[
      {title:'SEC sends "Regulation Crypto" proposal to White House OIRA — formal publication imminent',date:'Apr 2026',url:'https://www.pymnts.com/cryptocurrency/2026/sec-sends-regulation-crypto-proposal-to-white-house/'},
      {title:'CLARITY Act stablecoin yield compromise nearing resolution — passive yield banned, activity-based rewards permitted',date:'Apr 2026',url:'https://en.cryptonomist.ch/2026/04/14/stablecoin-regulation-senate-dma-act/'},
      {title:'FinCEN and OFAC propose GENIUS Act AML/sanctions rules — 1:1 reserves, monthly disclosures, transaction blocking required',date:'Apr 2026',url:'https://www.coindesk.com/policy/2026/04/08/u-s-treasury-to-propose-demands-that-stablecoin-firms-be-set-to-police-bad-transactions'},
      {title:'PARITY Act (crypto tax reform) reintroduced by Reps. Horsford and Miller',date:'Apr 2026',url:'https://www.coindesk.com/policy/2026/04/13/u-s-lawmakers-take-another-swing-at-crypto-tax-policy-with-revised-bill'},
      {title:'SEC publishes FY2025 enforcement results — only 456 actions (lowest in 21 years); 7 major crypto cases dismissed',date:'Apr 2026',url:'https://www.sec.gov/newsroom/press-releases/2026-34'},
      {title:'SEC staff statement clarifies broker-dealer registration requirements for DeFi front-end UI operators',date:'Apr 2026',url:'https://www.sec.gov/newsroom/speeches-statements/staff-statement-regarding-broker-dealer-registration-certain-user-interfaces-utilized-prepare-staff-statement-regarding-broker-dealer-registration-certain-user-interfaces-utilized'},
      {title:'Circle CEO defends not freezing ~$230M USDC after Drift exploit — says freezes require law enforcement or court orders',date:'Apr 2026',url:'https://www.theblock.co/post/397180/circle-ceo-allaire-defends-decision-not-to-freeze-usdc-in-drift-exploit-citing-moral-quandary'},
    ...
    framework:{
      title:'United States — Federal Multi-Agency + State Layer',
      intro:'The US operates the most fragmented crypto regulatory landscape globally. Federal jurisdiction splits across nine+ agencies grouped into three functional layers (markets, AML/sanctions/tax, banking), and 49+ state Money Transmitter Licence regimes apply on top. The GENIUS Act (Jul 2025) clarified stablecoins federally; the CLARITY Act (pending Senate) would streamline the SEC/CFTC split.',
      regulators:[
        {name:'SEC',fullName:'Securities and Exchange Commission',scope:'Federal — Markets',body:'Federal securities regulator. Applies the Howey investment-contract test to determine which tokens qualify as securities. "Regulation Crypto" proposal sent to White House OIRA in Apr 2026; FY2025 saw 7 major crypto cases dismissed under new SEC Chair Paul Atkins.'},
        {name:'CFTC',fullName:'Commodity Futures Trading Commission',scope:'Federal — Markets',body:'Federal commodities and derivatives regulator. Treats BTC and ETH as digital commodities. The pending CLARITY Act would expand CFTC jurisdiction to spot commodity markets — currently the agency primarily regulates derivatives, swaps, and futures.'},
        {name:'FinCEN',fullName:'Financial Crimes Enforcement Network',scope:'Federal — AML/Tax',body:'Treasury bureau handling AML. Requires Money Services Business (MSB) registration for crypto exchanges and custodians; enforces the Travel Rule for transfers above $3K. Proposed (Apr 2026) GENIUS Act AML rules for stablecoin issuers — 1:1 reserves, monthly disclosures, transaction-blocking capability.'},
        {name:'OFAC',fullName:'Office of Foreign Assets Control',scope:'Federal — AML/Tax',body:'Treasury bureau handling sanctions enforcement. Tornado Cash sanctions delisted Mar 2025 after the Fifth Circuit ruled in Van Loon v. Treasury that immutable smart contracts cannot be sanctioned as "property" of a designated entity.'},
        {name:'IRS',fullName:'Internal Revenue Service',scope:'Federal — AML/Tax',body:'Federal tax authority. Treats crypto as property — capital gains apply on disposal; staking rewards taxed as income at fair market value on receipt. The Infrastructure Investment and Jobs Act (2021) expanded the "broker" definition and added Form 1099-B reporting.'},
        {name:'OCC',fullName:'Office of the Comptroller of the Currency',scope:'Federal — Banking',body:'Treasury bureau regulating national banks. Has issued interpretive letters allowing national banks to custody crypto and hold stablecoin reserve deposits. Critical channel for the post-GENIUS stablecoin reserve banking framework.'},
        {name:'Federal Reserve',fullName:'Federal Reserve System',scope:'Federal — Banking',body:'Central bank with jurisdiction over bank holding companies and payment systems. Trump EO (Jan 2025) explicitly prohibited US CBDC development. Engages on stablecoin systemic risk and bank crypto operations.'},
        {name:'FDIC',fullName:'Federal Deposit Insurance Corporation',scope:'Federal — Banking',body:'Insures deposits at federally insured banks. Relevant for stablecoin reserves held in bank accounts under the GENIUS Act framework — issuers must hold reserves in FDIC-insured institutions or comparable structures.'},
        {name:'NYDFS',fullName:'New York Department of Financial Services',scope:'State',body:'State financial regulator administering the BitLicense — the toughest state crypto regime in the US, required for any service operating in or with New York residents. Heavy capital, compliance, and operational standards.'},
        {name:'Wyoming',fullName:'Wyoming Division of Banking / Secretary of State',scope:'State',body:'Most crypto-friendly state. The Wyoming DAO Supplement (2021) recognises DAOs as LLC variants; the Special Purpose Depository Institution (SPDI) charter (2019) provides a crypto-native bank structure. Common choice for RWA SPV and DAO foundation incorporation.'},
        {name:'49+ State MTLs',fullName:'State Money Transmitter Licences',scope:'State',body:'49 states plus DC require Money Transmitter Licences for crypto transmission activity (Montana excepted). Federal preemption under the GENIUS Act simplifies stablecoin issuance but the broader MTL patchwork remains a major operational cost — multi-state licensing typically takes 12-18 months.'},
      ],
    },
    analysis:[
      {activity:'Tokenisation — Funds & Securities',clarity:'partial',body:'Securities tokens fall under SEC jurisdiction via the Howey investment-contract test; tokenised funds engage the \'40 Act and the \'33 Act registration/exemption regime. The CLARITY Act (pending Senate) would draw a statutory line between SEC (investment contracts) and CFTC (digital commodities). SEC\'s "Regulation Crypto" (proposed Apr 2026) is expected to provide a comprehensive framework for tokenised-instrument issuance, custody, and broker-dealer registration.'},
      {activity:'RWA Tokenisation',clarity:'partial',body:'No federal RWA framework. Most RWA token issuances use existing \'33 Act exemptions — Reg D (private placement), Reg S (offshore), or Reg A+ (mini-IPO). Wyoming offers structural infrastructure (DLT Special Purpose Depository Institutions, DAO LLCs) suited to RWA SPV vehicles. The SEC under Atkins is more receptive to RWA pilots but has not issued a dedicated RWA rule package.'},
      {activity:'OTC Desks',clarity:'partial',body:'Multi-layered: federal MSB registration with FinCEN; state Money Transmitter Licences across 49+ states (Montana excepted); NYDFS BitLicense for NY-facing services. Desks dealing in tokens classed as securities additionally need SEC broker-dealer registration; commodity/derivative desks need CFTC FCM registration. The CLARITY Act would streamline the federal split but the state licensing burden remains.'},
      {activity:'Stablecoin-Backed Payments',clarity:'clear',body:'The GENIUS Act (signed Jul 2025) is the federal framework — payment stablecoins require 1:1 reserves, monthly public disclosures, and US-based compliance officers. FinCEN and OFAC proposed (Apr 2026) AML and sanctions rules including transaction-blocking capability; enforcement begins Jan 2027. Federal preemption simplifies the prior state-by-state patchwork. This is the most settled vertical in US crypto regulation post-2025.'},
      {activity:'Staking',clarity:'partial',body:'Previously a flashpoint — Kraken settled with the SEC in 2023 ($30M) over its staking program. The SEC under Atkins dismissed the parallel Coinbase staking case in 2025 with no penalties. No statutory safe harbor exists, but enforcement posture has shifted from "staking-as-securities-offering" to operational acceptance. The IRS treats staking rewards as income at fair market value on receipt.'},
    ]},
  ...
  SG:{name:'Singapore',status:'legal',summary:'Layered regulatory framework: Payment Services Act (domestic DPT), FSMA Part 9 (overseas DTSPs, effective Jun 2025), SFA (securities tokens). 36 MPI-licensed crypto providers as of Jan 2026. Stablecoin legislation expected mid-2026.',
    ...
    analysis:[
      {activity:'Tokenisation — Funds & Securities',clarity:'clear',body:'Tokenised securities and capital markets products fall squarely under the Securities and Futures Act (SFA), requiring a Capital Markets Services licence. Tokenised collective investment scheme interests remain CIS under the SFA regardless of token form. MAS\'s Project Guardian has actively piloted institutional-grade tokenised funds, bonds, and FX, providing one of the clearest tokenisation regimes globally.'},
      {activity:'RWA Tokenisation',clarity:'partial',body:'No bespoke RWA framework — treatment turns on the token\'s classification. Tokens representing securities, debt, or CIS interests fall under the SFA; tokens representing payment value fall under the Payment Services Act as digital payment tokens (DPTs). Project Guardian sandbox arrangements have enabled institutional RWA pilots (tokenised bonds, FX, MAS Bills), but a general retail RWA pathway outside these pilots remains unframed.'},
      {activity:'OTC Desks',clarity:'clear',body:'Domestic OTC services for digital payment tokens require Major Payment Institution licensing under the Payment Services Act. Overseas-facing OTC services operated from Singapore are captured by the Financial Services and Markets Act Part 9 (DTSP regime, effective Jun 2025). OTC desks dealing in tokens classed as capital markets products additionally need a CMS licence under the SFA.'},
      {activity:'Stablecoin-Backed Payments',clarity:'partial',body:'MAS issued a single-currency stablecoin (SCS) regulatory framework in 2023 requiring 100% reserve backing and redemption guarantees, but it currently operates as MAS expectations rather than statute — formal legislation is expected mid-2026. Compliant SCS payments are permitted via MPI-licensed providers; non-compliant stablecoins fall back to general DPT rules under the PSA.'},
      {activity:'Staking',clarity:'partial',body:'MAS Customer Protection Guidelines (2023) prohibit licensed DPT service providers from offering staking and lending services to retail customers in Singapore. Institutional staking and validator-as-a-service arrangements are less restricted but remain operationally ambiguous, with no statutory regime distinguishing custodial from non-custodial staking models.'},
    ]},
  ...
  JP:{name:'Japan',status:'legal',summary:'Cabinet approved landmark FIEA amendment (Apr 2026) reclassifying 105+ crypto assets as financial instruments — insider trading now banned, flat 20% tax proposed. Evolving from Payment Services Act framework to full securities-law treatment. First regulated yen-backed stablecoins launched. Mt. Gox repayments ongoing.',
    legislation:[
    ...
    news:[
      {title:'Cabinet approves FIEA amendment reclassifying crypto as financial instruments — insider trading banned, 20% flat tax proposed',date:'Apr 2026',url:'https://www.cryptotimes.io/2026/04/10/japan-reclassifies-crypto-assets-under-financial-instruments-act/'},
  ...
  IN:{name:'India',status:'partial',summary:'No comprehensive crypto law. Regulated via patchwork: PMLA notification (2023) mandates FIU-IND registration for all VDA service providers with full KYC/AML compliance and STR reporting. Finance Act 2022 imposes 30% tax + 1% TDS. 49 exchanges registered with FIU-IND. ~72.7% of trading moved offshore due to tax burden. SEBI monitoring tokens resembling securities from April 2025.',
    legislation:[
    ...
    framework:{
      title:'India — Regulator Patchwork',
      intro:'India has no comprehensive crypto law — instead, multiple regulators apply existing financial, tax, and AML statutes to crypto activity. Mandates often overlap, and friction between regulators (RBI vs SEBI vs Income Tax) shapes practical compliance more than any single piece of legislation.',
      regulators:[
        {name:'RBI',fullName:'Reserve Bank of India',scope:'Markets & Banking',body:'Central bank with primary jurisdiction over banking, payments, and the Digital Rupee (e₹) CBDC. Post-IAMAI v RBI (2020), the Supreme Court struck down RBI\'s banking ban as disproportionate. RBI now discourages banks from servicing crypto businesses but cannot prohibit outright; it favours the e₹ over private stablecoins.'},
        {name:'SEBI',fullName:'Securities and Exchange Board of India',scope:'Markets & Banking',body:'Capital markets regulator overseeing mutual funds (Mutual Funds Regulations 1996), AIFs (AIF Regulations 2012), and listed securities under SC(R)A 1956. Announced in April 2025 it would monitor tokens "resembling securities" but has not yet codified tokenised-securities rules.'},
        {name:'FIU-IND',fullName:'Financial Intelligence Unit — India',scope:'AML & Tax',body:'Central AML/KYC authority under the Prevention of Money Laundering Act (PMLA). The March 2023 VDA notification mandated all virtual digital asset service providers — domestic and offshore — to register as reporting entities with full KYC, record-keeping, and suspicious transaction reporting obligations.'},
        {name:'Income Tax / CBDT',fullName:'Central Board of Direct Taxes',scope:'AML & Tax',body:'Direct taxation under the Finance Act 2022: Section 115BBH imposes a flat 30% tax on all VDA gains with no loss set-off or carry-forward; Section 194S adds 1% TDS on transfers above ₹10K. The TDS layer creates a transaction paper trail that drove ~73% of trading volume offshore.'},
        {name:'CBIC / GST Council',fullName:'Central Board of Indirect Taxes and Customs',scope:'AML & Tax',body:'Indirect taxation. The GST Council clarified (2025) that 18% GST applies to all crypto exchange service fees — trading, staking, withdrawals — though not to the underlying crypto itself.'},
        {name:'IFSCA',fullName:'International Financial Services Centres Authority',scope:'Sandbox',body:'Unified regulator at GIFT City (Gujarat) operating a sandbox regime for tokenisation, fintech, and bullion-backed instruments. Currently the only structured pathway for compliant RWA tokenisation pilots originating from India.'},
        {name:'MoF',fullName:'Ministry of Finance',scope:'Policy',body:'Sets overall crypto policy through annual Finance Acts and coordinates between regulators. Has consistently signalled that comprehensive crypto legislation is "under consideration" but has not introduced a draft bill.'},
      ],
    },
    analysis:[
      {activity:'Tokenisation — Funds & Securities',clarity:'unclear',body:'No dedicated tokenisation framework. SEBI announced in April 2025 it would monitor tokens "resembling securities" but has not codified a tokenised-securities regime. Tokenised mutual funds, AIFs, or capital markets products default to existing SEBI regulations (SC(R)A 1956, Mutual Funds Regulations 1996, AIF Regulations 2012) — but no rulebook adapts these to token-based issuance and settlement.'},
      {activity:'RWA Tokenisation',clarity:'unclear',body:'No bespoke RWA framework. Issuance via an Indian SPV would engage existing securities law (SEBI), tax (30% VDA tax + 1% TDS), and AML (FIU-IND registration). IFSCA at GIFT City offers a sandbox for institutional tokenisation pilots — currently the only structured pathway for compliant RWA issuance originating from India.'},
      {activity:'OTC Desks',clarity:'partial',body:'OTC desks must register with FIU-IND as reporting entities under the PMLA VDA notification (2023), maintain full KYC/AML compliance, and report suspicious transactions. The 30% tax on gains plus 1% TDS at the transaction level apply regardless of OTC structure. No separate OTC licensing framework exists — operators sit within the general VASP perimeter.'},
      {activity:'Stablecoin-Backed Payments',clarity:'unclear',body:'No stablecoin regulation. RBI\'s posture is hostile — favouring the Digital Rupee (e₹) over private stablecoins, and discouraging banks from servicing crypto businesses. INR-backed stablecoin issuance from India is effectively blocked by the absence of a regulatory pathway. USD-stablecoin payments from India would also engage FEMA capital-flow restrictions.'},
      {activity:'Staking',clarity:'unclear',body:'No staking-specific regulation. Staking rewards are taxed as VDA income at 30% (CBDT clarification); 1% TDS applies on disposal; 18% GST applies to staking-service fees. No prohibition and no licensing framework — solo and pooled staking operate in an unframed grey area.'},
    ]},
  AE:{name:'UAE',status:'legal',summary:'Multi-layered regulation: VARA (Dubai), ADGM/FSRA (Abu Dhabi), CMA (federal, replaced SCA Jan 2026), CBUAE (central bank). CMA Decision No. 4/R.M/2026 (Feb 2026) establishes most comprehensive federal VASP framework in the region — 8 licensed activity categories, tiered capital requirements, privacy token ban. Dubai partners with Crypto.com for government crypto payments. Federal Decree Law No. 6 (2025) brings DeFi under CBUAE enforcement.',
    legislation:[
      ...
      {title:'CMA Decision No. 4/R.M/2026 — Federal VASP Licensing Framework',year:2026,note:'Most comprehensive federal virtual asset framework in the region; 8 licensed activity categories (exchange, custody, broker-dealer, advisory, portfolio mgmt, lending, transfer, investment); tiered capital requirements (AED 500K–4M); bans privacy tokens and algorithmic stablecoins; existing licensees must transition by Feb 2027',officialUrl:'https://neoslegal.co/uae-federal-crypto-regulations-explained/',url:'https://mielogroup.com/uae-crypto-law-2026-a-guide-to-cma-decision-no-4-r-m-2026-for-vasps/'},
    ],
    news:[
      {title:'Dubai partners with Crypto.com to enable crypto payments for government services — crypto converted to AED before deposit',date:'Apr 2026',url:'https://www.kucoin.com/news/flash/dubai-partners-with-crypto-com-to-enable-crypto-payments-for-government-services'},
      {title:'Dubai Insurance launches first crypto-enabled digital wallet in partnership with Zodia Custody',date:'Apr 2026',url:'https://ffnews.com/newsarticle/cryptocurrency/dubai-insurance-launches-first-crypto-enabled-digital-wallet-in-partnership-with-zodia-custody/'},
      {title:'CMA Decision No. 4/R.M/2026 establishes federal VASP licensing — 8 activity categories, tiered capital, privacy token ban',date:'Feb 2026',url:'https://mielogroup.com/uae-crypto-law-2026-a-guide-to-cma-decision-no-4-r-m-2026-for-vasps/'},
    ...
    framework:{
      title:'UAE — Multi-Regulator Routing',
      intro:'The UAE operates a federated crypto regime. Two federal regulators apply UAE-wide (CMA, CBUAE), and three zone-specific regulators handle activity in their respective jurisdictions (VARA for Dubai mainland, DFSA for DIFC, FSRA for ADGM).',
      regulators:[
        {name:'CMA',fullName:'Capital Markets Authority',scope:'Federal',body:'Replaced SCA in Jan 2026. CMA Decision No. 4/R.M/2026 establishes the federal VASP licensing framework — 8 activity categories, tiered capital requirements (AED 500K–4M), Feb 2027 transition deadline for existing licensees.'},
        {name:'CBUAE',fullName:'Central Bank of the UAE',scope:'Federal',body:'Payment Token Services Regulation (2024) governs stablecoin issuance with 100% segregated reserves. Federal Decree Law No. 6 of 2025 pulls DeFi, DEXs, wallets, bridges, and tokenised RWA under CBUAE supervision with fines up to AED 1B.'},
        {name:'VARA',fullName:'Virtual Assets Regulatory Authority',scope:'Dubai mainland (excl. DIFC)',body:'Established by Dubai Law No. 4 of 2022 — world\'s first standalone virtual-asset regulator. 13 rulebooks (5 compulsory + 8 activity-specific) covering 8 licensed activity categories: Advisory, Broker-Dealer, Custody, Exchange, Lending & Borrowing, Management & Investment, Transfer & Settlement, and VA Issuance.'},
        {name:'DFSA',fullName:'Dubai Financial Services Authority',scope:'DIFC',body:'Crypto Token Regime regulates crypto activity inside the DIFC zone. DIFC sits geographically inside Dubai but is legally extra-territorial — English common law–based jurisdiction with its own courts and commercial law.'},
        {name:'FSRA',fullName:'Financial Services Regulatory Authority',scope:'ADGM',body:'ADGM Digital Asset Framework with notification-based token listings and express bans on privacy tokens and algorithmic stablecoins. DLT Foundations Regulations (2023) — world\'s first DAO incorporation framework.'},
      ],
    },
    analysis:[
      {activity:'Tokenisation — Funds & Securities',clarity:'clear',body:'Tokenised securities and fund interests are routed by jurisdiction: federally, the CMA (replaced SCA in Jan 2026) supervises tokenised capital markets products under Decision No. 4/R.M/2026; ADGM\'s FSRA and DIFC\'s DFSA maintain parallel regimes inside their financial free zones. Tokenised fund interests remain within the federal/free-zone fund frameworks rather than defaulting to VASP rules. Dubai mainland tokens that aren\'t capital markets products fall to VARA.'},
      {activity:'RWA Tokenisation',clarity:'clear',body:'Federal Decree Law No. 6 of 2025 explicitly brings tokenised RWAs under CBUAE supervision, with fines up to AED 1B for unlicensed activity. Where the RWA token has capital-markets characteristics, CMA Decision No. 4/R.M/2026 also engages under federal VASP licensing. Free zones (ADGM, DIFC) operate their own RWA frameworks with notification-based listings and express bans on privacy tokens and algorithmic stablecoins; Dubai mainland RWA tokenisation runs through VARA\'s activity-specific rulebooks.'},
      {activity:'OTC Desks',clarity:'clear',body:'Federally, OTC desks fall within CMA Decision No. 4/R.M/2026 as "exchange", "broker-dealer", or "transfer" activity categories with tiered capital requirements (AED 500K–4M). In Dubai mainland, VARA\'s Virtual Asset Broker-Dealer Services Rulebook governs OTC operations. ADGM (FSRA) and DIFC (DFSA) license OTC activity within their respective zones. Existing licensees have until Feb 2027 to transition to the federal CMA regime.'},
      {activity:'Stablecoin-Backed Payments',clarity:'clear',body:'The CBUAE Payment Token Services Regulation (2024) requires central bank approval for stablecoin issuance with 100% segregated reserves. The first dirham-backed stablecoin (DDSC) was authorised in Feb 2026, with RAKBank\'s AED-backed stablecoin receiving in-principle approval. Federal Decree Law No. 6 of 2025 reinforces CBUAE jurisdiction over the payment-rail layer. Dubai\'s partnership with Crypto.com enables crypto-to-AED conversion for government services, but the stablecoin issuance leg remains CBUAE-controlled.'},
      {activity:'Staking',clarity:'partial',body:'CMA Decision No. 4/R.M/2026 includes "lending" as a regulated activity category, capturing yield-bearing staking products at the federal level. VARA addresses staking-related custodial activities under its Virtual Asset Management & Investment Services Rulebook. ADGM and DIFC apply general custody and collective investment frameworks rather than staking-specific rules. Solo (non-custodial) staking and validator-as-a-service remain outside the explicit perimeter.'},
    ]},
  ...
  SV:{name:'El Salvador',status:'legal',summary:'First country to adopt Bitcoin as legal tender (2021). Bitcoin Law amended Jan 2025 under IMF deal — merchant acceptance now voluntary, government wallet Chivo wound down. Digital Assets Issuance Law (2023) created CNAD as dedicated regulator for token offerings and exchanges.',
    ...
    analysis:[
      {activity:'Tokenisation — Funds & Securities',clarity:'clear',body:'The Digital Assets Issuance Law (2023) provides a single comprehensive regime for token offerings via CNAD. Tokenised securities and fund interests sit within this framework — CNAD authorisation is required for issuance, custody, and intermediation. The regime is purpose-built for token offerings rather than retrofitted from existing securities law, making it one of the cleaner tokenisation pathways in Latin America.'},
      {activity:'RWA Tokenisation',clarity:'partial',body:'RWA tokens fall within the Digital Assets Issuance Law\'s scope — CNAD licensing is required for issuance and intermediation. El Salvador has experimented with Bitcoin-backed sovereign debt ("Volcano Bonds") as a hybrid RWA structure. No dedicated RWA framework beyond the general digital asset regime; custody and enforcement of off-chain RWAs remain governed by the underlying asset\'s home-jurisdiction rules.'},
      {activity:'OTC Desks',clarity:'clear',body:'OTC desks require CNAD authorisation as digital asset service providers under the Digital Assets Issuance Law. AML/KYC obligations apply per CNAD rulebooks. No separate OTC-specific licensing tier — desks sit within the general DASP framework.'},
      {activity:'Stablecoin-Backed Payments',clarity:'partial',body:'USD has been El Salvador\'s primary legal tender since 2001 and remains so; BTC was added in 2021 but acceptance became voluntary in 2025 under the IMF Extended Fund Facility. No dedicated stablecoin regime — USD-backed stablecoin issuance from El Salvador would fall under the Digital Assets Issuance Law (CNAD). Payment-rail use of stablecoins is permitted but lacks specific operational rules.'},
      {activity:'Staking',clarity:'unclear',body:'No staking-specific provision. Staking-as-a-service likely falls within CNAD\'s "digital asset service provider" category, but the Digital Assets Issuance Law does not name staking as a regulated activity class. Solo staking and validator-as-a-service remain outside the explicit perimeter.'},
    ]},
  ...
  KY:{name:'Cayman Islands',status:'legal',summary:'Comprehensive VASP regime under the Virtual Asset (Service Providers) Act 2020 (VASPA), regulated by CIMA. Popular jurisdiction for crypto funds, DeFi foundations, and token issuances. Sandbox regime allows supervised launches of novel crypto products.',
    legislation:[
      ...
      {title:'Securities Investment Business Act (2020 Revision)',year:2020,note:'Securities regime relevant for RWA and tokenised securities — CIMA registration/licensing required for dealing in, arranging, managing, or advising on securities (per SIBA Schedule 1), regardless of whether the instrument is issued in tokenised form. Engages alongside VASPA where the token both qualifies as a security and involves a virtual asset service',officialUrl:'https://www.cima.ky/securities-investment-business'},
      {title:'Mutual Funds Act (2021 Revision)',year:2021,note:'Governs regulated open-ended mutual funds. CIMA permits tokenisation of fund equity interests within the MFA framework — tokenised mutual fund interests remain MFA-regulated rather than defaulting to VASPA/SIBA',officialUrl:'https://www.cima.ky/mutual-funds'},
      {title:'Private Funds Act (2020 Revision)',year:2020,note:'Governs closed-ended private funds. Same approach as MFA — tokenised private fund interests stay within the PFA regime. Fund-like vehicles falling outside both MFA and PFA scope may instead be captured by VASPA (issuance) and SIBA (where the token is a security)',officialUrl:'https://www.cima.ky/private-funds'},
    ],
    news:[
    ...
    analysis:[
      {activity:'Tokenisation — Funds & Securities',clarity:'partial',body:'Tokenised interests in regulated mutual funds and private funds sit within the MFA/PFA framework under CIMA supervision. Tokens that qualify as securities under SIBA Schedule 1 (shares, debentures, units in collective investment schemes, etc.) engage both VASPA at the issuance/service-provider layer and SIBA at the dealing/arranging layer. Tokens falling outside both categories default to VASPA as virtual asset issuances.'},
      {activity:'RWA Tokenisation',clarity:'partial',body:'Cayman has no bespoke RWA framework — treatment depends on how the underlying real-world asset is structured into the token. Tokens representing real estate, commodities, or receivables are typically issued through a Cayman SPV under VASPA, with SIBA additionally engaging where the token grants security-like rights. Custody of the underlying physical asset and the off-chain enforcement mechanism sit outside the Cayman crypto perimeter and remain governed by the asset\'s home-jurisdiction rules and contract law.'},
      {activity:'OTC Desks',clarity:'clear',body:'Crypto OTC desks fall squarely within VASPA. Operating a desk that exchanges fiat-to-crypto or crypto-to-crypto, or transfers virtual assets on behalf of clients, requires CIMA registration/licensing under VASPA Section 4. Desks dealing in tokens that qualify as securities additionally need SIBA authorisation for dealing-as-principal or arranging activities.'},
      {activity:'Stablecoin-Backed Payments',clarity:'partial',body:'No dedicated stablecoin regime in Cayman. Issuance of a stablecoin from Cayman is captured by VASPA (virtual asset issuance), but the payment-rail layer — stablecoin processors, merchant acquirers, remittance use cases — sits at the overlap of VASPA (transfer of virtual assets) and the Money Services Act. Treatment of fiat-backed reserves and redemption mechanics is not codified in stablecoin-specific rules; Banks and Trust Companies Act considerations may apply where the structure resembles deposit-taking.'},
      {activity:'Staking',clarity:'unclear',body:'No dedicated staking provision under Cayman law. Staking-as-a-service is likely captured by VASPA virtual asset custody or transfer service categories. CIMA has not issued staking-specific guidance, leaving operational treatment of slashing, reward distribution, and pooled stake structures undefined.'},
    ]},
  HK:{name:'Hong Kong',status:'legal',summary:'Robust VASP licensing regime under AMLO Part 5A (effective Jun 2023). SFC regulates all centralized crypto exchanges; 7 platforms licensed by late 2025. Stablecoins Ordinance enacted — HKMA granted first licences to HSBC and Anchorpoint Financial (Apr 2026), mandating 100% HQLA backing. Positions itself as Asia\'s crypto hub contrasting mainland China\'s ban.',
    legislation:[
    ...
    news:[
      {title:'HKMA grants first stablecoin licences under Stablecoins Ordinance to HSBC and Anchorpoint Financial (Standard Chartered/Animoca JV)',date:'Apr 2026',url:'https://www.spotedcrypto.com/global-crypto-regulation-wave-2026/'},
  ...
  KR:{name:'South Korea',status:'partial',summary:'Virtual Asset User Protection Act (VAUPA) effective Jul 2024 established investor protections. FSC is primary regulator. Digital Asset Basic Act (Apr 2026) proposed with 100%+ stablecoin reserves, VASP licensing, and exchange kill switches. BOK nominee backs CBDC over private stablecoins. Real-name bank account system required for all crypto trading.',
    legislation:[
      ...
      {title:'Digital Asset Basic Act (Proposed)',year:2026,note:'Comprehensive legislation proposing 100%+ stablecoin reserve requirements held at banks, VASP licensing, token listing standards, and 5-minute asset reconciliation with exchange kill switches',url:'https://www.coindesk.com/policy/2026/04/08/south-korea-proposes-cryptocurrency-law-with-bank-style-rules-for-stablecoins'},
    ],
    news:[
      {title:'National Assembly advances Digital Asset Basic Act — 100%+ stablecoin reserves, VASP licensing, exchange kill switches',date:'Apr 2026',url:'https://www.coindesk.com/policy/2026/04/08/south-korea-proposes-cryptocurrency-law-with-bank-style-rules-for-stablecoins'},
      {title:'Bank of Korea governor nominee backs central bank-led digital currency over private stablecoins',date:'Apr 2026',url:'https://www.coindesk.com/policy/2026/04/14/bank-of-korea-nominee-backs-central-bank-led-digital-currency-sees-limited-role-for-stablecoins'},
      {title:'Regulators impose 5-minute asset reconciliation checks and kill switches on crypto exchanges',date:'Apr 2026',url:'https://bitcoinke.io/2026/04/south-korea-tightens-crypto-exchange-controls/'},
  ...
  AU:{name:'Australia',status:'partial',summary:'Dual-regulator model: AUSTRAC (AML/CTF) and ASIC (consumer protection). Corporations Amendment (Digital Assets Framework) Bill passed Parliament (Apr 2026), requiring AFSL licensing for crypto platforms. AML/CTF Amendment Act 2024 expands VASP obligations from Jul 2026. Small operators under AUD$5K/customer and AUD$10M/year exempt.',
    legislation:[
    ...
    news:[
      {title:'Corporations Amendment (Digital Assets Framework) Bill passes Parliament — first comprehensive crypto licensing law enacted',date:'Apr 2026',url:'https://www.coindesk.com/policy/2026/04/01/australia-passes-crypto-licensing-bill-as-ausd24-billion-opportunity-comes-into-focus'},
  ...
  IR:{name:'Iran',status:'restricted',summary:'Central Bank of Iran is sole crypto regulator. Mining licensed since 2019 but ~95% of devices operate illegally. Domestic crypto payments banned. Licensed miners must sell holdings to CBI for imports. $7.8B crypto shadow economy used for sanctions circumvention. Nobitex exchange hacked for $90M in Jun 2025.',
    ...
    news:[
      {title:'Central Bank of Iran completes Digital Rial (crypto rial) CBDC pre-pilot on Hyperledger Fabric-based Borna platform',date:'Apr 2026',url:'https://usa.news-pravda.com/world/2026/04/12/739410.html'},
  ...
  ES:{name:'Spain',status:'legal',euMember:true,summary:'MiCA member state (CNMV as NCA). Bank of Spain registered VASPs under AML regime until Dec 2024; CNMV now handles CASP authorisation. Bit2Me became first Spanish MiCA-authorised CASP (Jul 2025). DAC8 crypto tax reporting effective Jan 2026. CNMV repealed Circular 1/2022 crypto advertising rules in favour of MiCA regime.',
    ...
    news:[
      {title:'ESMA warns unauthorized CASPs must complete orderly wind-down before Jul 1, 2026 MiCA deadline',date:'Apr 2026',url:'https://www.financemagnates.com/cryptocurrency/regulation/spain-to-enforce-mica-and-dac8-in-2026-ending-cryptos-regulatory-grey-area/'},
  ...
  KH:{name:'Cambodia',status:'restricted',summary:'Cambodia has emerged as a global epicentre of cyber-scam compounds that rely heavily on crypto for laundering. In March 2026, Parliament unanimously passed a new anti-scam law imposing up to life imprisonment for operators of technology fraud sites, especially where human trafficking or deaths are involved. The National Bank of Cambodia prohibits banks from dealing in crypto, but enforcement against scam operations using digital assets is now the government\'s top priority.',
    ...
    cases:[]},
  PA:{name:'Panama',status:'partial',summary:'No enacted crypto-specific law — digital assets are legal but largely unregulated. Bill 697 (2022) was vetoed by the president over AML concerns and struck down as unconstitutional by the Supreme Court (2023). Bill 247 (2025) proposes VASP licensing, crypto payment legalization, and a National Council of Digital Assets (CONAD). Draft Bill 487 (2026) envisions a broader fintech regime with regulatory sandbox. Panama City became the first government body to accept crypto payments (Apr 2025). Territorial tax system with no capital gains tax on crypto.',
    legislation:[
      {title:'Law No. 23/2015 — Anti-Money Laundering & Counter-Terrorist Financing',year:2015,note:'Primary AML/CFT framework; VASPs must comply with KYC, transaction monitoring, and suspicious activity reporting via the UAF',url:'https://www.lightspark.com/knowledge/is-crypto-legal-in-panama'},
      {title:'Law No. 129/2020 — Fintech Regulatory Framework',year:2020,note:'Regulatory framework for fintech companies including digital asset businesses; requires beneficial owner registry',url:'https://www.legalnodes.com/article/panama-crypto-regulations-insights-for-web3-founders-in-2025'},
      {title:'Bill No. 697 — Crypto Asset Regulation (Struck Down)',year:2022,note:'Passed by National Assembly Apr 2022; would have legalized crypto payments and DAOs. Vetoed by President Cortizo over AML concerns; declared unconstitutional by Supreme Court Jul 2023',officialUrl:'https://www.loc.gov/item/global-legal-monitor/2022-05-10/panama-national-assembly-passes-bill-regulating-cryptocurrency/',url:'https://www.centralbanking.com/fintech/crypto-assets/7959310/panama-supreme-court-rejects-crypto-law'},
      {title:'Bill No. 247 — Digital Assets and VASP Licensing (Proposed)',year:2025,note:'Proposes VASP licensing (1,500 balboas fee), legal recognition of crypto payments, creation of CONAD oversight body, and special tax regime. In subcommittee review since Sep 2025',url:'https://dig.watch/updates/panamas-draft-bill-sets-the-stage-for-crypto-payments'},
      {title:'Draft Bill 487 — Fintech and Blockchain Regime (Proposed)',year:2026,note:'Would create a Special Fintech Regime with blockchain licensing, an Interinstitutional Fintech Council, and a regulatory sandbox. Early stages of debate',url:'https://practiceguides.chambers.com/practice-guides/fintech-2026/panama/trends-and-developments'},
    ],
    news:[
      {title:'Draft Bill 487 proposes comprehensive fintech regime including blockchain licensing and regulatory sandbox',date:'Jan 2026',url:'https://practiceguides.chambers.com/practice-guides/fintech-2026/panama/trends-and-developments'},
      {title:'Panama signs OECD Crypto-Asset Reporting Framework (CARF-MCAA) for international tax transparency',date:'Dec 2025',url:'https://gofaizen-sherle.com/crypto-license/panama'},
      {title:'Panama could be next big player in crypto adoption as Bill 247 advances through legislature',date:'Sep 2025',url:'https://newsroompanama.com/2025/09/23/could-panama-be-the-next-big-player-in-crypto-adoption/'},
      {title:'Panama removed from EU list of high-risk third countries for money laundering',date:'Jun 2025',url:'https://finance.ec.europa.eu/news/commission-updates-list-high-risk-countries-strengthen-international-fight-against-financial-crime-2025-06-10_en'},
      {title:'Panama City Council votes to accept BTC, ETH, USDC, USDT for taxes and municipal fees — first government body in the country',date:'Apr 2025',url:'https://cointelegraph.com/news/panama-city-votes-accept-crypto-taxes-fees'},
    ],
    cases:[
      {title:'OneCoin/Billions Trade Club — cross-border crypto fraud ($4B global scheme)',status:'32 properties seized in Panama; suspect Galbiati arrested in Italy',year:2025,url:'https://newsroompanama.com/2025/03/02/cryptocurrency-scam-that-crossed-borders-into-panama/'},
      {title:'Supreme Court strikes down Bill 697 — entire crypto law declared unconstitutional',status:'Bill invalidated',year:2023,url:'https://www.centralbanking.com/fintech/crypto-assets/7959310/panama-supreme-court-rejects-crypto-law'},
      {title:'President Cortizo partial veto of Bill 697 over AML/FATF compliance concerns',status:'Vetoed — returned to National Assembly',year:2022,url:'https://digitalpolicyalert.org/event/5694-partial-veto-of-crypto-bill-by-the-panamanian-president'},
    ]},
  NO:{name:'Norway',status:'legal',summary:'EEA member implementing MiCA via the Crypto Asset Act (Kryptoeiendelsloven), effective Jul 2025. Finanstilsynet supervises all CASPs. Distinctive stance on mining — new proof-of-work data centres banned from autumn 2025 to preserve hydropower capacity. Crypto gains taxed at 22%; mandatory third-party reporting from Jan 2026. Norges Bank concluded a digital krone is not currently needed (Dec 2025).',
    legislation:[
      {title:'Crypto Asset Act (Kryptoeiendelsloven) — MiCA Implementation',year:2025,note:'Implements EU MiCA into Norwegian law via EEA Agreement; comprehensive framework for CASPs, stablecoins, market abuse. Effective Jul 1, 2025; transition for existing providers likely extended to Jun 30, 2026',url:'https://www.wintherlaw.com/news/norwegian-government-unveils-proposal-to-implement-mica-in-national-law'},
      {title:'Anti-Money Laundering Act (Hvitvaskingsloven) — VASP Registration',year:2018,note:'Crypto exchange and custody providers must register with Finanstilsynet and comply with AML/KYC rules; predates MiCA',url:'https://www.globallegalinsights.com/practice-areas/blockchain-cryptocurrency-laws-and-regulations/norway/'},
      {title:'Transfer of Funds Regulation II (TFR II) — Travel Rule',year:2025,note:'Requires originator/beneficiary info to accompany all crypto-asset transfers; adopted alongside MiCA via EEA Agreement',url:'https://svw.no/en/insights/norway-takes-steps-towards-digital-operational-resilience-and-crypto-asset-regulation'},
      {title:'Data Center Registration & Crypto Mining Ban',year:2025,note:'Europe\'s first mandatory data centre registry (Nkom, Jan 2025). New proof-of-work mining data centres banned from autumn 2025; existing operations may continue. Fines up to 5% of annual turnover',url:'https://www.coindesk.com/tech/2025/06/23/norway-plans-ban-on-new-crypto-mining-data-centers-to-preserve-power'},
      {title:'Third-Party Crypto Reporting Regime',year:2026,note:'From Jan 2026, Norwegian crypto service providers must share client transaction data with tax authorities',url:'https://dig.watch/updates/norway-sees-surge-in-cryptocurrency-tax-declarations'},
    ],
    news:[
      {title:'MiCA transition period for existing crypto providers likely extended by 6 months to Jun 30, 2026',date:'Early 2026',url:'https://www.kaupr.io/en/news/transition-scheme-for-crypto-exchanges-in-norway-is-likely-to-be-extended-by-six-months'},
      {title:'Third-party crypto reporting regime takes effect — exchanges must share client data with tax authorities',date:'Jan 2026',url:'https://dig.watch/updates/norway-sees-surge-in-cryptocurrency-tax-declarations'},
      {title:'Norges Bank concludes digital krone (CBDC) is not currently warranted; pauses development',date:'Dec 2025',url:'https://www.norges-bank.no/en/news-events/news/News-items/2025/25-12-10-cbdc/'},
      {title:'Norway bans new proof-of-work crypto mining data centres to preserve energy capacity',date:'Oct 2025',url:'https://www.coindesk.com/tech/2025/06/23/norway-plans-ban-on-new-crypto-mining-data-centers-to-preserve-power'},
      {title:'Crypto Asset Act (Kryptoeiendelsloven) enters into force, implementing MiCA in Norway',date:'Jul 2025',url:'https://www.kaupr.io/en/news/cryptocurrencies-and-digital-assets-become-norwegian-law'},
      {title:'Norway sees 30% surge in cryptocurrency tax declarations in 2024 amid enforcement push',date:'2025',url:'https://en.coinotag.com/norways-crypto-declarations-surge-30-in-2024-amid-tax-enforcement-with-bitcoin-exposure-in-wealth-fund/'},
    ],
    cases:[
      {title:'NOK 900M (~$87M) crypto investment fraud (OctaCoin/NanoCoin/Ormeus Coin)',status:'4 men charged; multi-country scheme; NOK 700M+ laundered through Norwegian law firm',year:2025,url:'https://decrypt.co/306550/norway-charges-four-over-87-million-crypto-investment-fraud'},
    ]},
  BY:{name:'Belarus',status:'legal',summary:'Legalized crypto broadly in 2017 via Decree No. 8, making it the first country to comprehensively regulate blockchain activities, with the Hi-Tech Park (HTP) as regulatory hub and tax benefits through 2049. Since 2024, individual tax exemptions apply only to domestic HTP-platform trades (foreign/P2P taxed at 13%). Major offshore exchanges (Bybit, OKX, Bitget) blocked Dec 2025. Decree No. 19 (Jan 2026) created a new "cryptobank" category. CBDC (digital ruble) targeted for late 2026.',
    legislation:[
      {title:'Decree No. 8 — On the Development of the Digital Economy',year:2017,note:'Landmark decree legalizing cryptocurrencies, ICOs, smart contracts, and mining. HTP established as regulatory hub. Tax exemptions for individuals and HTP residents guaranteed through 2049',officialUrl:'https://park.by/en/press/news/post-1749/'},
      {title:'Presidential Decree — Tax Reform for Crypto',year:2024,note:'Ended blanket individual tax exemption from Jan 2025. Tax-free treatment now only for transactions via domestic HTP-resident platforms. P2P and foreign-platform trades taxed at 13%',url:'https://www.mexc.co/en-IN/news/906263'},
      {title:'Decree No. 19 — Crypto Bank Framework',year:2026,note:'Creates legal category of "cryptobanks" — joint-stock companies combining token-based operations with traditional banking; must be HTP residents and registered with the National Bank',url:'https://coinnews.com/news/belarus-establishes-new-legal-framework-for-national-crypto-bank-sector/'},
      {title:'Ministry of Information Order — Foreign Exchange Blocking',year:2025,note:'Blocked access to Bybit, OKX, Bitget, BingX, Gate, and Weex for advertising violations and to channel trading to domestic platforms',url:'https://www.dlnews.com/articles/regulation/belarus-blocks-access-to-bybit-bitget-and-okx/'},
    ],
    news:[
      {title:'Belarus creates legal framework for "cryptobanks" via Decree No. 19',date:'Jan 2026',url:'https://www.tradingview.com/news/cointelegraph:ff7a50465094b:0-belarus-creates-legal-framework-for-cryptobanks-in-new-presidential-decree/'},
      {title:'Belarus fast-tracks CBDC (digital ruble) launch for second half of 2026',date:'2026',url:'https://cryptorank.io/news/feed/2103a-belarus-to-complete-cbdc-launch-by-second-half-2026-central-bank-chief'},
      {title:'Belarus blocks access to major offshore crypto exchanges (Bybit, OKX, Bitget, BingX, Gate)',date:'Dec 2025',url:'https://www.financemagnates.com/cryptocurrency/exchange/belarus-just-blocked-major-crypto-exchanges-what-should-brokers-prepare-for/'},
      {title:'Belarus seeks to cement role as crypto "digital haven" — Lukashenko pushes transparent rules',date:'Sep 2025',url:'https://www.coindesk.com/policy/2025/09/06/belarus-seeks-to-cement-role-as-crypto-digital-haven-president-lukashenko-says'},
      {title:'Belarus banks ordered to adopt crypto and tokenization as sanctions squeeze economy',date:'2025',url:'https://decrypt.co/338912/belarus-banks-ordered-adopt-crypto-tokenization-sanctions'},
    ],
    cases:[
      {title:'Crackdown on 27 illegal crypto exchange operators — ~22M BYN (~$8.7M) seized',status:'27 individuals identified; illegal income confiscated',year:2023,url:'https://www.lightspark.com/knowledge/is-crypto-legal-in-belarus'},
      {title:'EU sanctions extended to Belarus crypto assets',status:'EU clarified crypto-assets are "transferrable securities" under Belarus sanctions regime',year:2022,url:'https://www.coindesk.com/policy/2022/03/09/eu-says-russia-belarus-sanctions-extend-to-crypto'},
    ]},
  TR:{name:'Turkey',status:'legal',summary:'Comprehensive framework under Law No. 7518 (Jul 2024) amending the Capital Markets Law. CMB/SPK licenses all CASPs with minimum TRY 100M capital. FATF-aligned Travel Rule effective Feb 2025. Proposed 10% crypto tax was introduced then withdrawn by parliament (Mar 2026). Digital Turkish Lira CBDC Phase 2 completed (Nov 2025). One of the world\'s largest crypto markets (~$200B volume in 2025).',
    legislation:[
      {title:'Law No. 7518 — Amendment to the Capital Markets Law',year:2024,note:'Primary crypto legislation: defines crypto assets, establishes CMB licensing for CASPs, custody rules, criminal penalties for unlicensed operation',officialUrl:'https://www.mondaq.com/turkey/fin-tech/1492978/crypto-assets-are-being-regulated-law-numbered-7518-on-amending-the-capital-markets-law-is-published'},
      {title:'CBRT Payment Ban Regulation',year:2021,note:'Prohibits use of crypto assets for payments for goods/services; bans payment service providers from facilitating crypto transactions',url:'https://cms.law/en/int/expert-guides/cms-expert-guide-to-crypto-regulation/turkiye'},
      {title:'Law No. 5549 (AML Law) — VASP Amendment',year:2021,note:'Recognized VASPs as obliged entities under AML framework; requires MASAK registration',url:'https://notabene.id/world/turkey'},
      {title:'CMB Communique III-35/B.1 — CASP Founding & Operational Principles',year:2025,note:'Rules for CASP establishment: minimum capital TRY 100M for platforms, TRY 50M for custody-only; governance and management qualifications',url:'https://practiceguides.chambers.com/practice-guides/blockchain-2025/turkey/trends-and-developments'},
      {title:'CMB Communique III-35/B.2 — Working Principles & Capital Adequacy',year:2025,note:'Operational procedures, capital adequacy, custody safeguards (95% of customer assets in authorised custody), internal controls',url:'https://www.globallegalinsights.com/practice-areas/blockchain-cryptocurrency-laws-and-regulations/turkey-turkiye/'},
      {title:'MASAK AML/CTF Amendment — Travel Rule',year:2025,note:'Full Travel Rule implementation from Feb 25, 2025; VASPs must collect and transmit originator/beneficiary data for all crypto transactions',url:'https://notabene.id/world/turkey'},
    ],
    news:[
      {title:'Turkey crypto tax regulation (10% income tax) withdrawn by parliament',date:'Mar 2026',url:'https://www.paturkey.com/news/2026/turkey-crypto-tax-regulation-withdrawn-by-parliament-29234/'},
      {title:'Turkey\'s ruling AK Party unveils 10% crypto income tax proposal',date:'Mar 2026',url:'https://www.coindesk.com/policy/2026/03/02/turkey-s-ruling-party-unveils-10-crypto-income-tax-proposal'},
      {title:'Digital Turkish Lira Phase Two report published — CBDC advancing with programmable payments and offline NFC',date:'Nov 2025',url:'https://www.paturkey.com/news/2025/digital-turkish-lira-advances-phase-two-report-highlights-25542/'},
      {title:'CMB issues CASP licensing communiques (III-35/B.1 and B.2)',date:'Mar 2025',url:'https://www.globallegalinsights.com/practice-areas/blockchain-cryptocurrency-laws-and-regulations/turkey-turkiye/'},
      {title:'MASAK Travel Rule fully enters force for all VASPs',date:'Feb 2025',url:'https://notabene.id/world/turkey'},
      {title:'CASP licensing deadline set for Jun 30, 2026',date:'2025',url:'https://www.bitget.com/amp/academy/turkey-crypto-rules'},
    ],
    cases:[
      {title:'Thodex / Faruk Fatih Ozer — $2B exchange fraud',status:'CEO sentenced to 11,196 years; found dead in prison Oct 2025',year:2021,url:'https://www.coindesk.com/policy/2023/09/08/11196-years-in-prison-for-faruk-ozer-ceo-of-collapsed-turkish-crypto-exchange-thodex'},
      {title:'Vebitcoin / Ilker Bas — exchange collapse',status:'CEO and 3 employees arrested; ~$60M daily volume, 200,000 affected users',year:2021,url:'https://www.cnbc.com/2021/04/26/turkish-bitcoin-exchange-vebitcoin-collapses-amid-crypto-crackdown.html'},
    ]},
};
